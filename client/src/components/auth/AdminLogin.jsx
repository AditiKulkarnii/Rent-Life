...
function AdminLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (email === import.meta.env.VITE_ADMIN_EMAIL && password === import.meta.env.VITE_PASSWORD) {
    ...
    <div className="px-5 sm:px-10 md:px-20 lg:px-32 py-5 h-screen overflow-y-hidden bg-slate-200">
      <div className="navbar pt-3 flex items-center justify-between px-5">
        <div className="text-black text-2xl sm:text-3xl font-bold cursor-pointer">
          <span className="text-blue-400 font-extrabold text-3xl sm:text-4xl">
            Rent-
          </span>
          a-Life
        </div>
          ...
          >
            <form onSubmit={handleLogin}>
              ...
              <div className="flex gap-3 sm:gap-10 items-center justify-center sm:justify-start mt-5 sm:mt-10">
                ...
                <FaFacebook className="text-lg sm:text-2xl hover:text-white duration-200 cursor-pointer" />
                <FaGoogle className="text-lg sm:text-2xl hover:text-white duration-200 cursor-pointer" />
                <FaTwitter className="text-lg sm:text-2xl hover:text-white duration-200 cursor-pointer" />
              </div>
            </form>
            <ToastContainer />
          </div>
