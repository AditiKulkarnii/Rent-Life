    ...
    var options = {
      ...
      handler: async function (response) {
        try {
          ...
          await db.collection('House').doc(productId).delete();
          navigate('/');
        } catch (error) {
                    ...
                    <div className="mr-4">
                      ...
                      <div>
                       ...
                       <div className="mt-4 mb-4">
                        ...
                        <div className="flex items-center mt-2">
                          <FontAwesomeIcon icon={faCouch} className="text-gray-500 mr-2" />
                          <span className="text-gray-700">{product.Furnished ? 'Furnished' : 'Unfurnished'}</span>
                        </div>
                      </div>
                      {/* End Icons */}
